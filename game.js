...
var bg = {
    ...
    draw : function(){
        ...
        ctx.drawImage(sprite, this.sX, this.sY, this.w, this.h, this.x + this.w, this.y, this.w, this.h)  // چون عرض عکسمون از عرض کنوس ما کوچکتر هست پس مجدد عکس رو میکشیم اما نه از مبدا 0 بلکه از انتهای عکس قبلی
    }
}
